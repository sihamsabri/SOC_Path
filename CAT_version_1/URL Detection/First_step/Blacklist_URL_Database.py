...
def urls_file_download(Download_API, extract_dir) :
    ...
    URLs_FinalFile_Path = "/home/cat/shared/URL Detection/First_step/" + (zip_file.namelist())[0]

    # The following is the path(name) of the extracted file :
    #print(URLs_FinalFile_Path)
...
extract_dir = "/home/cat/shared/URL Detection/First_step/"

# Here we took the final path of the database, we will use it later to process the database !
